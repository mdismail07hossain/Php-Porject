...
<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link" data-bs-toggle="dropdown" href="#" title="Expired"> <i class="bi bi-bell fs-3"></i> <span class="navbar-badge badge text-bg-danger fs-6">0</span> </a>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="./asstes/images/4209.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                          ...
                          <div class="dropdown-divider"></div> <a href="#" class="dropdown-item dropdown-footer">See All Messages</a>
                            <img src="./asstes/images/4209.jpg" width="200"  alt="User Avatar">
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="./asstes/images/4209.jpg" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">Admin</span> </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            ...
                            <li class="user-footer"> <a href="#" class="btn btn-default btn-flat  text-white bg-dark">Profile</a> <a href="logout.php" class="btn btn-default btn-flat float-end text-white bg-dark">Sign out</a> </li> <!--end::Menu Footer-->
                        </ul>
