        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="form-horizontal" method="POST" id="submitBrandForm" action="./php_action/create_medicine_type.php" enctype="multipart/form-data">
              ...
              <!-- Status -->
              <div class="form-group row">
                <label class="col-sm-3 control-label" for="typeStatus">Status</label>
                <div class="col-sm-9">
                  <select class="form-control" id="unitStatus" name="typeStatus" required>
  ...
  <!-- display category list  -->
   ...
   <div class="container my-5">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <?php
                    $active_type='';
                    $type_status = $db->query("SELECT * FROM medicine_type");
                    if($type_status->num_rows > 0){
                      $counter = 1;
                      while (list($id,$type,$status) = $type_status->fetch_row()) {
                        if($status == 1) {
                          ...
                          $active_type = "<span class='badge bg-warning text-dark'>Inactive</span>";
                              ...
                              <td>$active_type</td>
                              <td>
                                  <a href='./edit_form_type_medicine.php?id=$id' 
